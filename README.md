...
* Offline speech recognition via a pre-trained maching learing model using TinyML and Tensorflow. &nbsp; [[STARTED :construction_worker:]](https://github.com/TIT8/shelly_button_esp32_arduino/tree/master/speech_recognition)
